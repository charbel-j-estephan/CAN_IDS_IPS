...
\usepackage{mathptmx}
\usepackage[letterpaper,margin=1in,columnsep=18pt]{geometry}
\usepackage{array}
\usepackage{booktabs}
\usepackage{tabularx}
\usepackage{url}
...
\begin{titlepage}
  \centering
  \vspace*{48pt}
  {\Large\bfseries Faculty of Engineering\\ECCE Department\par}
  \vspace{63pt}
  {\Large\bfseries EEN 527\\Embedded System Design\par}
  {\large Section A\par}
  \vspace{71pt}
  {\large\bfseries Instructor:\par}
  \vspace{8pt}
  {\large\itshape Dr.\ Abdallah Kassem\par}
  \vspace{70pt}
  {Literature Review\par}
  \vspace{11pt}
  {\large\bfseries FPGA Based Intrusion Detection and\\
   Prevention System for CAN Bus Networks\par}
  \vspace{56pt}
  {Submitted by:\par}
  \vspace{9pt}
  {\large Anthony El Chakar \#20231589\\
   Charbel Estephan \#20231222\\
   Joe Geagea \#20201000\par}
\end{titlepage}
...
Vehicular Communications, vol.~55, article 100956, 2025.
...
for in vehicle network, in Proceedings of the 16th Annual Conference on
Privacy, Security and Trust, 2018, pages 1 to 6.
...
cyber attacks with a low cost platform, IEEE Access, vol.~9, pages
...
automotive CAN bus using random forest, in Proceedings of the
...
network CAN bus, in Proceedings of the IEEE International Carnahan
Conference on Security Technology, 2016.
...
integrated CAN controllers, in Proceedings of the 55th Annual IEEE and
...
detection system on hybrid FPGAs, in Proceedings of the International
...
low cost FPGA, Journal of Systems Architecture, vol.~156, article
103285, 2024.
...
IEEE Access, vol.~13, pages 129856 to 129869, 2025.
...
for ECUs, Electronics, vol.~15, no.~10, article 2108, 2026.

\bibitem{kurachi2014}
R.~Kurachi, Y.~Matsubara, H.~Takada, N.~Adachi, Y.~Miyashita, and
S.~Horihata, CaCAN, centralized authentication system in CAN, in
Proceedings of the 14th International Conference on Embedded Security in
...
Proceedings of the 24th International Symposium on Parallel and
...
\bibitem{emlearn}
J.~Nordby, emlearn, a library for converting trained scikit learn models,
including random forests, into portable C code for microcontrollers, GitHub
repository, \url{github.com/emlearn/emlearn}.
